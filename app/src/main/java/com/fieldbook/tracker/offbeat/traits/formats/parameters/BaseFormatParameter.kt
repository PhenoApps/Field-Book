 ...
 */
abstract class BaseFormatParameter {
    private val uniqueId = UUID.randomUUID().toString()

    /**
     * ViewTypes are one-to-one with the Parameters enum ordinals, and are used during the
     ...
     */
    abstract fun getName(ctx: Context): String
