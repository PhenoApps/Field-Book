...
//                        }
        ...
        fun migrateToVersion17(db: SQLiteDatabase) {

            StudyConfigurationVersion17().migrate(db)
                .onFailure {
                    Log.e(TAG, "Failed to migrate to version 17", it)
                }
                .onSuccess {
        ...
        fun migrateToVersion21(db: SQLiteDatabase) {

            ObservationMediaMigratorVersion21().migrate(db)
                .onFailure {
                    Log.e(TAG, "Failed to migrate to version 21", it)
                }
                .onSuccess {
        ...
        fun migrateToVersion22(db: SQLiteDatabase) {
            ...
            ImageNamingAttributeVersion22().migrate(db)
                .onFailure {
