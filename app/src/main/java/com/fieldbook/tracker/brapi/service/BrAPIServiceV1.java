            ...
            BrapiV1ApiCallBack<StudyObservationVariablesResponse> callback = new BrapiV1ApiCallBack<StudyObservationVariablesResponse>() {
                ...
                public void onSuccess(StudyObservationVariablesResponse response, int i, Map<String, List<String>> map) {
                    ...
                    if (response != null) {
                        ...
                        StudyObservationVariablesResponseResult result = response.getResult();

                        if (result != null) {

                            List<ObservationVariable> variables = result.getData();

                            if (variables != null) {

                                Pair<List<TraitObject>, Integer> traitResult = mapTraits(variables);
