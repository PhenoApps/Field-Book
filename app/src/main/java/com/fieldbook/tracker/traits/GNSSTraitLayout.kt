...
class GNSSTraitLayout : BaseTraitLayout, GPSTracker.GPSTrackerListener {
    ...
    override fun init(act: Activity) {
        ...
        chipGroup = findTraitView(R.id.gnss_trait_averaging_chip_group)
        averageSwitch = findTraitView(R.id.gnss_trait_averaging_switch)
        connectButton = findTraitView(R.id.gnss_connect_button)
        utcTextView = findTraitView(R.id.utcTextView)
        satTextView = findTraitView(R.id.satTextView)
        altTextView = findTraitView(R.id.altTextView)
        accTextView = findTraitView(R.id.accTextView)
        latTextView = findTraitView(R.id.latTextView)
        lngTextView = findTraitView(R.id.lngTextView)
        hdopTextView = findTraitView(R.id.hdopTextView)
        connectGroup = findTraitView(R.id.gnss_group)
        collectButton = findTraitView(R.id.gnss_collect_button)
        disconnectButton = findTraitView(R.id.disconnect_button)
        precisionSp = findTraitView(R.id.precisionSpinner)
        progressBar = findTraitView(R.id.trait_gnss_pb)
