...
enum class Formats {
    ...
    //SYSTEM formats
    AUDIO, BOOLEAN, CAMERA, CATEGORICAL, COUNTER, DATE, LOCATION, NUMERIC, PERCENT, TEXT, ANGLE, BASE_SPECTRAL,

    CUSTOM, DISEASE_RATING, GNSS, STOP_WATCH,
    BASE_PHOTO, VIDEO,
    USB_CAMERA, GO_PRO, CANON,
    NIX, INNO_SPECTRA_SENSOR, GREEN_SEEKER,
