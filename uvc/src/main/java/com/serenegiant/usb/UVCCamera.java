 ...
 *
 * Copyright (c) 2014-2017 saki t_saki@com.com.serenegiant.com
 *
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
    ...
    /**
     * Signal native preview threads that USB is gone (hot-unplug).
     * Call before soft-release; avoids joining threads stuck in libusb.
     */
    public void setUsbGone() {
    	if (mNativePtr != 0) {
    		nativeSetUsbGone(mNativePtr);
    	}
    }

    /** Join preview/capture/pump after setUsbGone — call off the USB callback thread. */
    public void joinAfterUsbGone() {
    	if (mNativePtr != 0) {
    		nativeJoinAfterUsbGone(mNativePtr);
    	}
    }
...
//================================================================================
    ...
    private static final native void nativeSetUsbGone(final long id_camera);
    private static final native void nativeJoinAfterUsbGone(final long id_camera);
