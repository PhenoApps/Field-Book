...
public class SearchActivity extends Activity
{
	...
	public void addRow(String text, String colName)
	{
		...
		ArrayAdapter adapter = new ArrayAdapter(SearchActivity.this, R.layout.smallspinnerlayout5, likes);
		...
		if (col != null)
		{
			...
			ArrayAdapter adapter2 = new ArrayAdapter(SearchActivity.this, R.layout.smallspinnerlayout5, 
