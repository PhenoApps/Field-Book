...
# <img class="icon-title" src="../_static/icons/formats/bee.png"> Pollinator Trait
...
<figure class="image">
  <img class="screenshot" src="../_static/images/traits/formats/joined_pollinator_format.png" width="700px"> 
